          ...
          <div className="w-full lg:w-1/2 lg:ml-16 lg:mt-10">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-2 text-gray-700">
                ...
                become an Programmer , Then here we are for you. All you have to
                do is Practice again and again. We provide best learning mathod
                and guidline.
              </p>
              <h1 className="mt-3 text-xl font-semibold">Our Courses Have :</h1>
